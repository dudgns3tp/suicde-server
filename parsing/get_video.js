...
console.log(word_number+'번째까지 비디오 저장');
// origin_no 1부터 word_number 단어의 개수만큼 url을 변경시켜서 요소 추출
for(origin_no=1; origin_no <=word_number; origin_no++){
    ...
    scrap.$("video#html5video").each(function(idx){ 
...
/*         if(!src.match('common')){ //common 값을 가진 파일은 제거해준다.
             ...
             fname = savedir+ "/"+ pad(origin_no,5)+'('+cnt+').mp4';
             //다운로드
